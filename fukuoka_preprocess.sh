...
tail -n +2 401307_public_facility_sports.csv |  awk 'BEGIN {FS=",";OFS=","} {print $5,$6,$7,$9,$11,$12,"\""$11,$12"\"",$13,"sports"} ' >> fukuoka_converted.csv
tail -n +2 401307_public_facility_library.csv  | awk 'BEGIN {FS=",";OFS=","} {print $5,$6,$7,$9,$11,$12,"\""$11,$12"\"",$13,"library"} ' >> fukuoka_converted.csv 
tail -n +2 401307_public_facility_culture.csv  | awk 'BEGIN {FS=",";OFS=","} {print $5,$6,$7,$9,$11,$12,"\""$11,$12"\"",$13,"culture"} ' >> fukuoka_converted.csv 
tail -n +2 401307_public_facility_museum.csv | awk 'BEGIN {FS=",";OFS=","} {print $5,$6,$7,$9,$11,$12,"\""$11,$12"\"",$13,"museum"} ' >> fukuoka_converted.csv 
