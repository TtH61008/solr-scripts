...
echo "name,name_kana,name_pop,address,latitude,longitude,phone_number" > fukuoka_converted.csv 

tail -n +2 401307_public_facility_sports.csv | cut -d ',' -f  5,6,7,9,11,12,13 >> fukuoka_converted.csv
tail -n +2 401307_public_facility_library.csv  | cut -d ',' -f  5,6,7,9,11,12,13 >> fukuoka_converted.csv
tail -n +2 401307_public_facility_culture.csv  | cut -d ',' -f  5,6,7,9,11,12,13 >> fukuoka_converted.csv
tail -n +2 401307_public_facility_museum.csv | cut -d ',' -f  5,6,7,9,11,12,13 >> fukuoka_converted.csv
